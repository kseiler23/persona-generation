"""Async version of BLP extractor for concurrent processing."""
...
@dataclass
class AsyncBLPExtractor:
    """
    Async version of BLPExtractor for concurrent processing.
    """
    ...
    async def extract(self, anonymized_transcript: str) -> BehavioralLinguisticProfile:
        """
